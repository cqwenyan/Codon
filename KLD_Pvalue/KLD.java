...
public class KLD {
	...
	public static void main(String[] args) {
		...
		String inputFileName = "mulberry_300.fasta";
		noSpaceTempFile(inputFileName, path);
		int binSize = 10;
		int binNumber = 5;
		KLD_Builder(binSize, binNumber, path, "tempNoSpace.fasta", true);
		KLD_Pvalue(binSize, binNumber, path, inputFileName, 5);
